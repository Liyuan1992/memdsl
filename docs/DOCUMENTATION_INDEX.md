...
The practical design describes the implemented Phase -1 through Phase 5
source line and the evidence-gated deferral of practical Phase 6/7. It does
not implement the paper's authority ledger, digest-bound grants, proof
objects, live reduction closure, or `Verify` sinks.
