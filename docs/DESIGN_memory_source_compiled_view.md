...
- 状态：架构提案，分阶段实施中；Phase -1、0A、0B、1、2、3、4、5 已落地
- 当前基线：memdsl 0.6.0，Phase 5 本提交（parent `e128d351b670bfb1aabe04fa36f5bcdaa4d0b1cb`）
...
4. 一等 edge 最终采用 core syntax 还是 domain declaration？
5. 语义历史是否永久留在热 Source，何时需要 cold-history contract？
6. 新能力的目标版本和 deprecation window 多长？
